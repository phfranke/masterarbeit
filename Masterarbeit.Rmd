...
- `pond`: Laichgewässer, enthält die Einheiten aus `groundCover` welche als Typ `stehendes Gewässer` aufweisen.
...
Ein Experiment bestätigt diese Theorie. In einer weiteren Modellversion, wird die Dichteabhängigkeit abgestellt und einen fixen Wert für die Sterblichkeit der Larven definiert. Das Modell ist dadurch nicht mehr kalibriert und kann keine glaubhaften Resultate liefern, das Experiment dient hier lediglich dazu die Ursache der Oszillation zu finden.  
