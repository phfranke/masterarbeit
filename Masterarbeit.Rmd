...
Beim Eier legen wird ein Agent der Spezies Nachwuchs geschaffen. Dabei werden folgende Variabeln gesetzt:
- *count*: Gemäss Parameter *clutchSize*
...
##### Juvenile
Die Spezies Juvenil erhält die Fähigkeit zu wandern. Ein durch Parameter festgelegter Anteil der Juvenilen zu Agenten der Spezies "Migrant". Nach Ablauf der Wanderung werden sie wiederum zu Agenten der Spezies "Juvenile". Die Entwicklung zu Adulten ist wiederum durch den Kalender gesteuert und beinhaltet eine Sterblichkeitsrate.

##### Migrant {#speciesMigrant}
Die Spezies Migrant kann sowohl Agenten aus der Spezies "Juvenile" als auch aus der Spezies "Adulte" aufnehmen. Dieser Spezies ist die Fähigkeit der Wanderung vorbehalten. Als Wanderung wird hier der Wechsel des Brutgewässers bezeichnet. Die Wanderung selber ist in Kapitel \@ref(wanderung) beschrieben. Nach Ablauf der Wanderzeit wird jedes Individuum in die ursprünglich Spezies zurückverwandelt ("Juvenile" oder "Adulte").

##### Adulte
Adulte habe die komplexesten Eigenschaften der modellierten Spezies. Sie können viele Jahre alt werden und unterliegen einer jährlichen Sterblichkeitsrate. Sie können Wanderungen unternehmen (siehe Kapitel \@ref(wanderung) und \@ref(speciesMigrant)), und pflanzen sich als einzige Spezies in diesem Modell fort.
